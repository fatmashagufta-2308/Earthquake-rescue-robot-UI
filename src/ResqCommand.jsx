...
export default function ResqCommand() {
  ...
  function spawnRoute() {
    ...
    setRouteToasts((prev) => [...prev, route]);
    bump();
  }
  ...
  return (
    <div style={{ background: t.bg, color: t.text, fontFamily: t.font, borderRadius: 16, padding: 12, minHeight: "100vh", boxSizing: "border-box", display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ background: `${t.panel}c8`, backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: `0.5px solid ${t.border}`, borderRadius: 10, padding: 10 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {alerts.slice(0, 6).map((a) => (
                    <button key={a.id} onClick={() => focusMarker(a.markerId)}
                      style={{ textAlign: "left", cursor: "pointer", border: `0.5px solid ${t.border}`, borderLeft: `3px solid ${sevColor[a.severity]}`, borderRadius: 7, padding: "6px 8px" }}>
      ...
      {reportViewer && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50, padding: 20 }}
          ...
          <div onClick={(e) => e.stopPropagation()}
            ...
            <pre style={{ margin: 0, overflowY: "auto", fontSize: 11, lineHeight: 1.6, color: t.text, background: t.panel2, border: `0.5px solid ${t.border}`, borderRadius: 8, padding: 14, fontFamily: "ui-monospace, monospace", whiteSpace: "pre-wrap" }}>
